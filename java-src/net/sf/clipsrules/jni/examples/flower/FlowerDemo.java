package net.sf.clipsrules.jni.examples.flower;
...
class FlowerDemo implements ActionListener
  {  
   ...
   ResourceBundle flowerResources;
   ...
   FlowerDemo()
     {  
      try
        {
         flowerResources = ResourceBundle.getBundle("net.sf.clipsrules.jni.examples.flower.resources.FlowerResources",Locale.getDefault());
        }
      ...
      JFrame jfrm = new JFrame(flowerResources.getString("FlowerDemo"));  
      ...
      prevButton = new JButton(flowerResources.getString("Prev"));
      prevButton.setActionCommand("Prev");
      buttonPanel.add(prevButton);
      prevButton.addActionListener(this);
      
      nextButton = new JButton(flowerResources.getString("Next"));
      ...
      /*==========================*/
      /* Load the flower program. */
      /*==========================*/

      clips = new Environment();
      
      clips.loadFromResource("/net/sf/clipsrules/jni/examples/flower/resources/bcengine.clp");
      clips.loadFromResource("/net/sf/clipsrules/jni/examples/flower/resources/flower.clp");
      clips.loadFromResource("/net/sf/clipsrules/jni/examples/flower/resources/flower_" + 
   ...
   private void handleResponse() throws Exception
     {
      ...
      if (fv.getFactSlot("state").toString().equals("conclusion"))
        { 
         ...
         nextButton.setText(flowerResources.getString("Restart")); 
      ...
      else if (fv.getFactSlot("state").toString().equals("greeting"))
        {
         ...
         nextButton.setActionCommand("Next");
         nextButton.setText(flowerResources.getString("Next"));
   ...
   public static void main(String args[])
     {  
      ...
      SwingUtilities.invokeLater(
        new Runnable() 
          {  
           public void run() { new FlowerDemo(); }  
          });   
     }  
  }
